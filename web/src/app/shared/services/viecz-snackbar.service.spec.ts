...
import { VieczSnackbarService } from './viecz-snackbar.service';
import { TranslocoService } from '@jsverse/transloco';
import { provideTranslocoForTesting } from '../../core/transloco-testing';

describe('VieczSnackbarService', () => {
  let service: VieczSnackbarService;

  beforeEach(() => {
    vi.useFakeTimers();
    service = TestBed.inject(VieczSnackbarService);
  });
