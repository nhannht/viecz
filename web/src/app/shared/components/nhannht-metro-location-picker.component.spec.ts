...
import { NhannhtMetroLocationPickerComponent } from './nhannht-metro-location-picker.component';

describe('NhannhtMetroLocationPickerComponent', () => {
  let component: NhannhtMetroLocationPickerComponent;
  let fixture: ComponentFixture<NhannhtMetroLocationPickerComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [NhannhtMetroLocationPickerComponent, FormsModule],
    ...
    fixture = TestBed.createComponent(NhannhtMetroLocationPickerComponent);
  ...
  describe('SSR safety', () => {
    it('mapReady stays false on server platform', async () => {
      ...
      const serverFixture = TestBed.createComponent(NhannhtMetroLocationPickerComponent);
