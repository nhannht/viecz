...
describe('VieczSelectComponent', () => {
  let fixture: ComponentFixture<VieczSelectComponent>;
  let component: VieczSelectComponent;

  beforeEach(async () => {
    await TestBed.configureTestingModule({ imports: [VieczSelectComponent] }).compileComponents();
    fixture = TestBed.createComponent(VieczSelectComponent);
