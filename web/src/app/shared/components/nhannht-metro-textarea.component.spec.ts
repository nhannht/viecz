...
describe('NhannhtMetroTextareaComponent', () => {
  let fixture: ComponentFixture<NhannhtMetroTextareaComponent>;
  let component: NhannhtMetroTextareaComponent;

  beforeEach(async () => {
    await TestBed.configureTestingModule({ imports: [NhannhtMetroTextareaComponent] }).compileComponents();
    fixture = TestBed.createComponent(NhannhtMetroTextareaComponent);
