 ...
 * @example
 * ```html
 * <viecz-badge label="OPEN" status="open" />
 * <viecz-badge label="IN PROGRESS" status="in_progress" />
 * <viecz-badge label="POPULAR" />
 * ```
 */
@Component({
  selector: 'viecz-badge',
  standalone: true,
  template: `
    <span
...
export class VieczBadgeComponent {
