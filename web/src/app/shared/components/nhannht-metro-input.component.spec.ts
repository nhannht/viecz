...
describe('NhannhtMetroInputComponent', () => {
  let fixture: ComponentFixture<NhannhtMetroInputComponent>;
  let component: NhannhtMetroInputComponent;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [NhannhtMetroInputComponent],
    }).compileComponents();
    fixture = TestBed.createComponent(NhannhtMetroInputComponent);
