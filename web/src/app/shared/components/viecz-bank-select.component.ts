...
@Component({
  ...
  `,
  providers: [
    { provide: NG_VALUE_ACCESSOR, useExisting: forwardRef(() => VieczBankSelectComponent), multi: true },
  ],
})
export class VieczBankSelectComponent implements ControlValueAccessor {
  label = input('');
  placeholder = input('');
