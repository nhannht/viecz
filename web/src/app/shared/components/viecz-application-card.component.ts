 ...
 */
@Component({
  selector: 'viecz-application-card',
  standalone: true,
  imports: [RouterLink, TranslocoDirective, VieczBadgeComponent, VieczButtonComponent, VndPipe, TimeAgoPipe],
  template: `
    <ng-container *transloco="let t">
      <div class="bg-card border border-border p-6 font-body">
        <div class="flex items-center justify-between mb-3">
          ...
          <viecz-badge [label]="application().status.toUpperCase()" [status]="badgeStatus()" />
        </div>
...
export class VieczApplicationCardComponent {
