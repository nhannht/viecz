 ...
 * Uses `appearance: none` to remove browser chrome and applies viecz
...
@Component({
  ...
  `,
  providers: [
    { provide: NG_VALUE_ACCESSOR, useExisting: forwardRef(() => VieczSelectComponent), multi: true },
  ],
})
export class VieczSelectComponent implements ControlValueAccessor {
