...
import { VieczBankSelectComponent } from './viecz-bank-select.component';
...
describe('VieczBankSelectComponent', () => {
  let component: VieczBankSelectComponent;
  let fixture: ComponentFixture<VieczBankSelectComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [VieczBankSelectComponent, FormsModule],
    }).compileComponents();

    fixture = TestBed.createComponent(VieczBankSelectComponent);
