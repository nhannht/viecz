...
const meta: Meta<NhannhtMetroStepComponent> = {
  title: 'nhannht-metro/Step',
  component: NhannhtMetroStepComponent,
  tags: ['autodocs'],
};

export default meta;
type Story = StoryObj<NhannhtMetroStepComponent>;
