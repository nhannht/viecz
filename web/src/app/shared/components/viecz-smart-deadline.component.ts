...
@Component({
  ...
  `,
  providers: [
    { provide: NG_VALUE_ACCESSOR, useExisting: forwardRef(() => VieczSmartDeadlineComponent), multi: true },
  ],
})
export class VieczSmartDeadlineComponent implements ControlValueAccessor {
  label = input('');
  error = input('');
