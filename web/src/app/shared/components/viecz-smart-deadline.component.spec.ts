...
describe('VieczSmartDeadlineComponent', () => {
  let fixture: ComponentFixture<VieczSmartDeadlineComponent>;
  let component: VieczSmartDeadlineComponent;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [VieczSmartDeadlineComponent],
      providers: [provideTranslocoForTesting()],
    }).compileComponents();
    fixture = TestBed.createComponent(VieczSmartDeadlineComponent);
