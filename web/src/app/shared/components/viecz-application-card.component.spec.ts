...
@Component({
  standalone: true,
  imports: [VieczApplicationCardComponent],
  template: `<viecz-application-card
    [application]="app()"
...
describe('VieczApplicationCardComponent', () => {
  ...
  it('should display tasker name when available', () => {
    expect(fixture.nativeElement.textContent).toContain('Nguyen Van A');
  });

  it('should fall back to tasker ID when name is not available', () => {
    host.app.set({ ...mockApp, tasker: undefined });
    fixture.detectChanges();
  ...
  it('should emit acceptClick with application id', () => {
    host.showAccept.set(true);
    fixture.detectChanges();
    const btn = fixture.nativeElement.querySelector('viecz-button button') as HTMLButtonElement;
    btn.click();
  ...
  it('should map accepted status to completed badge', () => {
    host.app.set({ ...mockApp, status: 'accepted' });
    fixture.detectChanges();
    const badge = fixture.nativeElement.querySelector('viecz-badge');
