...
/**
 * Date picker using native `<input type="date">` with viecz styling.
 *
...
@Component({
  ...
  `,
  providers: [
    { provide: NG_VALUE_ACCESSOR, useExisting: forwardRef(() => VieczDatepickerComponent), multi: true },
  ],
})
export class VieczDatepickerComponent implements ControlValueAccessor {
