...
import { VieczTaskCardComponent } from './viecz-task-card.component';
...
const meta: Meta<VieczTaskCardComponent> = {
  title: 'viecz/TaskCard',
  component: VieczTaskCardComponent,
  tags: ['autodocs'],
  decorators: [
...
export default meta;
type Story = StoryObj<VieczTaskCardComponent>;
