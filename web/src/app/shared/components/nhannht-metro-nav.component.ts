 ...
 */
@Component({
  selector: 'nhannht-metro-nav',
  standalone: true,
  imports: [RouterLink, RouterLinkActive, NhannhtMetroIconComponent],
  template: `
      ...
      <div class="flex items-center gap-6">
        @for (link of links(); track link.route) {
          <a [routerLink]="link.route"
            ...
            @if (link.icon) {
              <nhannht-metro-icon [name]="link.icon" [size]="18" />
            }
...
export class NhannhtMetroNavComponent {
