...
describe('VieczNavComponent', () => {
  ...
  it('should render icon when link has icon property', () => {
    const icons = fixture.nativeElement.querySelectorAll('viecz-icon');
  ...
  it('should not render icon for links without icon', () => {
    ...
    const navIcons = fixture.nativeElement.querySelectorAll('viecz-icon');
  ...
  describe('template conditional toggles', () => {
    it('should toggle icon rendering when a link has its icon removed', () => {
      ...
      let icons = fixture.nativeElement.querySelectorAll('viecz-icon');
      ...
      fixture.detectChanges();
      icons = fixture.nativeElement.querySelectorAll('viecz-icon');
    ...
    it('should toggle icon rendering when a link gets an icon added', () => {
      ...
      fixture.detectChanges();
      expect(fixture.nativeElement.querySelectorAll('viecz-icon').length).toBe(0);
      ...
      fixture.detectChanges();
      expect(fixture.nativeElement.querySelectorAll('viecz-icon').length).toBe(2);
    });
