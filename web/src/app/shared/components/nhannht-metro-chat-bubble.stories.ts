...
const meta: Meta<NhannhtMetroChatBubbleComponent> = {
  title: 'nhannht-metro/ChatBubble',
  component: NhannhtMetroChatBubbleComponent,
  tags: ['autodocs'],
};

export default meta;
type Story = StoryObj<NhannhtMetroChatBubbleComponent>;
  ...
  render: () => ({
    template: `
      <div style="max-width: 500px;">
        <nhannht-metro-chat-bubble [message]="their1" [isMine]="false" />
        <nhannht-metro-chat-bubble [message]="my1" [isMine]="true" />
        <nhannht-metro-chat-bubble [message]="their2" [isMine]="false" />
      </div>
    `,
    props: {
