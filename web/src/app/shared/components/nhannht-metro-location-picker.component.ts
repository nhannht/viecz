...
@Component({
  selector: 'nhannht-metro-location-picker',
  standalone: true,
  imports: [FormsModule],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => NhannhtMetroLocationPickerComponent),
      multi: true,
    },
  ],
  template: `
...
export class NhannhtMetroLocationPickerComponent implements OnInit, OnDestroy, ControlValueAccessor {
  @Input() label = '';
  @Input() placeholder = '';
  @Input() error = '';
