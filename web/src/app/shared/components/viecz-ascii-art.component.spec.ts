...
describe('VieczAsciiArtComponent', () => {
  let fixture: ComponentFixture<VieczAsciiArtComponent>;
  let component: VieczAsciiArtComponent;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      imports: [VieczAsciiArtComponent],
    }).compileComponents();
    fixture = TestBed.createComponent(VieczAsciiArtComponent);
