...
/**
 * Action button following the viecz-meow design system.
 *
 ...
 * @example
 * ```html
 * <viecz-button variant="primary" label="Submit" (clicked)="onSubmit()" />
 * <viecz-button variant="secondary" label="Learn More" />
 * ```
 */
@Component({
  selector: 'viecz-button',
  standalone: true,
  template: `
    <button
      [class]="btnClass()"
...
export class VieczButtonComponent {
